...
通过浏览器打开：http://localhost:8080/spring-mvc-test
...
-------------------
 ...
 如果你要在Linux环境运行，以下的文件需要修改。
	...
	$ location="file:/opt/web/spring-mvc-test/resources/application.properties"/>
...
--------------------
spring-mvc-test is a mini project using Spring MVC.
...
Access the deployed web application at: http://localhost:8080/spring-mvc-test
...
Import spring-mvc-test as a Maven Project
