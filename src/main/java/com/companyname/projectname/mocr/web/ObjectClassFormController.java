...
import com.companyname.projectname.mocr.validation.ObjectClassDataValidator;
...
//		}
	...
	public String processSubmit(ObjectClassListType ojbclslisttype, @ModelAttribute("userinfo") UserInfo userinfo, 
		...
		textsb.append(":8080/companyname-projectname-mocr/requeststatus?mocrid=");
		...
		textsb.append("http://");
		textsb.append(propertiesBean.getWebhostname());
		textsb.append(":8080/companyname-projectname-mocr/");
